    ...
    render() {
        const onSuccess = (payment) => {
            // Congratulation, it came here means everything's fine!
            		console.log("Покупку завершено", payment);
        ...
        const client = {
            sandbox:    'AZhBHwrgg0RuHmhZ7i1HyEpVUebkBNCDVOBt5pWSRnnwbrnl6ODpNbmKKCpdVyco_arAZmwtyjuZ8gUL',
